...
Ben's attempt to make a parallel version using joblib is in the other branch 'B_parallel'. The B_parallel version is faster and uses less disk space, so is recommended.
